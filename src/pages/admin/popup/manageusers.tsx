      ...
      <ModalContent>
        ...
        <form onSubmit={e => { e.preventDefault(); }}>
          ...
          <FormGroup>
            <InputBox>
              <label>부서명</label>
              <input type="text" name="user_dept_name" value={user.user_dept_name || ''} onChange={onChange} />
            </InputBox>
          </FormGroup>
          <FormGroup>
            <InputBox>
              <label>팀명</label>
              <input type="text" name="user_team_name" value={user.user_team_name || ''} onChange={onChange} />
            </InputBox>
          </FormGroup>
          <FormGroup>
            <InputBox>
              <label>직무</label>
              <input type="text" name="user_jobname" value={user.user_jobname || ''} onChange={onChange} />
            </InputBox>
          </FormGroup>
          <ButtonRow>
